...
app = FastAPI(title="Legal Compliance Inference API", version="1.0.0")
...
class PredictionRequest(BaseModel):
    ...
    model: str = "auto"  # auto, baseline, transformer
    explain: bool = True
...
async def health_check():
    ...
    return {"status": "healthy", "model_variant": get_model_variant()}
